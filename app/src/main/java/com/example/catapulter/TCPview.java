...
public class TCPview extends View {
    ...
    private void init(@Nullable AttributeSet set)
    {
        ...
        mTCP_ClientMain = new TCP_ClientMain(new TCP_ClientMain.TCP_ClientClassInterface() {
            ...
            @Override
            public void onDisconnected(String statusStr) {
        ...
        else
        {
            if(System.currentTimeMillis() - lastTime < delayTime) //how much time you decide
            {
                ...
                if (touchPoint.intersect(mRect_IP_Address)) {
                    ...
                    Snackbar.make(this, "SELECT NEW SERVER?", Snackbar.LENGTH_SHORT).setAction("YES", new OnClickListener() {
                        @Override
                    ...
                    Snackbar.make(this, "SELECT NEW PORT?", Snackbar.LENGTH_SHORT).setAction("YES", new OnClickListener() {
                        @Override
                        public void onClick(View v) {
                    ...
                    Snackbar.make(this, "CONNECTION INFO?", Snackbar.LENGTH_SHORT).setAction("YES", new OnClickListener() {
                        @Override
                        public void onClick(View v) {
    ...
    public interface TCPviewEventListenerInterface {
        //We include this interface so that outer classes and their routines can be called if required. The class listening to these events must hence declare
