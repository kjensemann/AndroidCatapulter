...
public class TCP_ClientMain {
    /*
        ...
        public void onDisconnected(string statusMsg)                    --> Feeds back any status available
    ...
    public void disConnect(){
        ...
        mTCP_ClientClassInterface.onDisconnected("NORMAL Disconnect"); //Infors outside listeners.
    ...
    public interface TCP_ClientClassInterface{
        ...
        public void onDisconnected(String statusMsg);
